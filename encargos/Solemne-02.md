...
function draw() {
  ...
  for (let i = 0; i < objetos.length; i++) {
    ...
    if (o.posY > height - o.r || o.posY < o.r) {
      o.dirY *= -1;
    }

    // interacción con mouse
    let d = dist(mouseX, mouseY, o.posX, o.posY);

    if (d < o.r) {
      o.imgActual = o.imgHover;
    } else {
      o.imgActual = o.imgBase;
    }

    // dibujar imagen centrada
    imageMode(CENTER);
    image(o.imgActual, o.posX, o.posY, o.r * 2, o.r * 2);
  }
